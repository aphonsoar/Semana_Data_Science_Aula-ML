...
# Os dados utilizados no arquivo 'data.csv' são oriúndos do Jupyter NB 'aula03', onde o modelo foi treinado.

# função para carregar o dataset
@st.cache
def get_data():
    return pd.read_csv('~/aphonso/Ap/Git/Semana_Data_Science_Aula-ML/Maio-20/data.csv')
